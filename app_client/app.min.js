! function () {
    ...
    function e(n, e, t) {
        n.$on("$routeChangeStart", function (n, o, r) {
            "/users" !== e.path() || t.isAdminLoggedIn() || e.path("/")
        })
    }
...
function () {
    function n(n, e) {
        var t = this;
        t.users = [], e.getProfile().success(function (n) {
            t.user = n
        }).error(function (n) {
            console.log(n)
        }), e.usersGrab().success(function (n) {
            t.users = n
        }).error(function (n) {
            console.log(n)
        })
...
function () {
    function n(n, e, t) {
        var o = this;
        o.users = [], e.usersGrab().success(function (n) {
            o.users = n, console.log(n)
        }).error(function (n) {
            console.log(n)
        })
    }
...
function () {
    function n(n, e, t) {
        ...
        o.credentials = {
            ...
            e.login(o.credentials).error(function (n) {
                alert(n)
            }).then(function () {
                n.path("/users")
            })
...
function () {
    function n(n, e) {
        var t = function (n) {
            ...
            r = function () {
                var n, t = o();
                return !!t && (n = t.split(".")[1], n = e.atob(n), n = JSON.parse(n), console.log(n), console.log(n.exp), console.log(n.email), console.log(n.admin), n.exp > Date.now() / 1e3)
            },
            i = function () {
                var n, t = o();
                return !!t && (n = t.split(".")[1], n = e.atob(n), n = JSON.parse(n), 2 == n.admin && n.exp > Date.now() / 1e3)
            },
            l = function () {
                if (r()) {
                    var n = o(),
